...
const allFaqs = [
  ...
  { role: "seller", question: "How do I start selling on NorthLane?", answer: "Create a listing in minutes with photos, a description, and your price. Once approved, your item will be visible to buyers on the platform." },
